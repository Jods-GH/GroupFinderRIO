...
local function createMainFrame()
    ...
    local GroupFinderRiotext = frame:CreateFontString("GroupFinderRio", "OVERLAY", "GameFontNormal")
    GroupFinderRiotext:SetPoint("TOPRIGHT", frame.TitleContainer, "TOPRIGHT", 10, -5)
    GroupFinderRiotext:SetText("GroupFinderRio")
    GroupFinderRiotext:SetParent(frame.TitleContainer)
